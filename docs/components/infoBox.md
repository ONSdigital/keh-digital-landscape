...
| `relatedItems`            | array    | `[]`                                        | List of related technology items to show in the InfoBox                                                                                                                                                                                                                                                  |
| `onRelatedItemClick`      | function | `undefined`                                 | Handler invoked when a related technology is clicked                                                                                                                                                                                                                                                     |
| `tagOptions`              | array    | `[]`                                        | Controlled tag options; format: `{ label, value }[]`                                                                                                                                                                                                                                                     |
