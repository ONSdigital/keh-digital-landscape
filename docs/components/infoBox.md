...
| `relatedItems`            | array    | `[]`                                        | Optional list of related technology items to show in the InfoBox                                                                                                                                                                                                                                         |
| `onRelatedItemClick`      | function | `undefined`                                 | Optional handler invoked when a related technology is clicked                                                                                                                                                                                                                                            |
| `tagOptions`              | array    | `[]`                                        | Controlled tag options (for admins/reviewers to edit tags); format: `{ label, value }[]`                                                                                                                                                                                                                 |
